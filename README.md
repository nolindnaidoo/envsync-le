...
<p align="center">
  <!-- VS Code Marketplace -->
  <a href="https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.envsync-le">
    <img src="https://img.shields.io/visual-studio-marketplace/v/OffensiveEdge.envsync-le" alt="VSCode Marketplace Version" />
  </a>
  <!-- Open VSX -->
  <a href="https://open-vsx.org/extension/OffensiveEdge/envsync-le">
    <img src="https://img.shields.io/open-vsx/v/OffensiveEdge/envsync-le" alt="Open VSX Version" />
  </a>
  <!-- Build -->
  <a href="https://github.com/OffensiveEdge/envsync-le/actions">
    <img src="https://img.shields.io/github/actions/workflow/status/OffensiveEdge/envsync-le/ci.yml?branch=main" alt="Build Status" />
  </a>
  <!-- License -->
  <a href="https://github.com/OffensiveEdge/envsync-le/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/OffensiveEdge/envsync-le" alt="MIT License" />
  </a>
</p>
...
Thank you for using EnvSync-LE! If this extension has been helpful in managing your environment files, please consider leaving a rating on [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.envsync-le) and [Open VSX](https://open-vsx.org/extension/OffensiveEdge/envsync-le). Your feedback helps other developers discover this tool and motivates continued development.

⭐ **Enjoying EnvSync-LE?** [Leave a rating](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.envsync-le) and help others find it too!
...
- **Scrape-LE** - Verify page reachability and detect anti-scraping measures before deploying scrapers  
  [[VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.scrape-le)]

- **Colors-LE** - Extract and analyze colors from CSS, HTML, JavaScript, and TypeScript  
  [[VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.colors-le)] [[Open VSX](https://open-vsx.org/extension/OffensiveEdge/colors-le)]
...
1. **Install from VS Code Marketplace or Open VSX**
   - VS Code Marketplace: [Install here](https://marketplace.visualstudio.com/items?itemName=OffensiveEdge.envsync-le)
...
- **66.66% function coverage, 17.05% line coverage**
