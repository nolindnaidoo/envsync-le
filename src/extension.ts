...
import { createVSCodeConfiguration, createVSCodeFileSystem, createVSCodeUserInterface } from './adapters'
...
export function activate(context: vscode.ExtensionContext): void {
	...
	const notifier = createVSCodeNotifier({ window: vscode.window, readConfig: readConfig }, configuration)
